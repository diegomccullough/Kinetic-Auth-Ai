...
export default function VerificationOverlay({ open, onClose, onVerified }: VerificationOverlayProps) {
                  ...
                  <div className="relative px-5 pb-6 pt-6">
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        ...
                        <p className="mt-2 text-sm text-white/65">Confirm a human-held device with motion.</p>
                      </div>
